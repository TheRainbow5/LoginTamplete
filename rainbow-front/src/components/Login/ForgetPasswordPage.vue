        ...
        <div style="margin-top:30px; margin-left: 10px; margin-right: 30px;">
            <el-form :model="forgetForm" :rules="rules" ref="forgetForm" status-icon>
                <el-form-item prop="username" style="height: 40px;">
                    <el-input tyle="text" placeholder="用户名" autocomplete="on" v-model="forgetForm.username"
                ...
                <el-form-item prop="validationCode" style="height: 40px;">
                    <el-row>
                        <el-col :span="16" style="text-align: left;">
                            <el-input tyle="text" placeholder="请输入电子邮箱验证码" clearable v-model="forgetForm.validationCode" />
                        </el-col>
